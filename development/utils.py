...
from reconstructionGPU2 import recon_setup, recon



def string_prep(dictionary, jwt): 
    '''
    Takes a dictionary of settings and a JSON Web Token for SF API submission. 
    Returns a pickled and encoded string.
    '''
...
def get_jwt(filename):
    '''
    Takes a filename with SF API credentials in a dictionary. 
